...
public class MainActivity extends BaseActivity<ActivityMainBinding> {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        getBinding().list.addItemDecoration(new DividerItemDecoration(this, DividerItemDecoration.VERTICAL));
        ...
        RvItemClickSupport.addTo(getBinding().list).setOnItemClickListener(new RvItemClickSupport.OnItemClickListener() {
            @Override
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                switch (position) {
                    case 0:
                        module.startNextActivity(MainActivity.this, data.get(position), DownloadActivity.class);
                        break;
                    case 1:
                        module.startNextActivity(MainActivity.this, data.get(position), HttpUploadActivity.class);
                        break;
                    case 2:
                        module.startNextActivity(MainActivity.this, data.get(position), DownloadGroupActivity.class);
                        break;
                    case 3:
                        module.startNextActivity(MainActivity.this, data.get(position), FtpDownloadActivity.class);
                        break;
                    case 4:
                        module.startNextActivity(MainActivity.this, data.get(position), FTPDirDownloadActivity.class);
                        break;
                    case 5:
                        module.startNextActivity(MainActivity.this, data.get(position), FtpUploadActivity.class);
                        break;
                    case 6:
                        module.startNextActivity(MainActivity.this, data.get(position), M3U8VodDLoadActivity.class);
                        break;
                    case 7:
                        module.startNextActivity(MainActivity.this, data.get(position), M3U8LiveDLoadActivity.class);
                        break;
                    case 8: // d_sftp
                        module.startNextActivity(MainActivity.this, data.get(position), SFtpDownloadActivity.class);
                        break;
                    case 9: // u_sftp
                        module.startNextActivity(MainActivity.this, data.get(position), SFtpUploadActivity.class);
                        break;
                }
            }
        });
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            boolean hasPermission = PermissionManager.getInstance().checkPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
            if (!hasPermission) {
                PermissionManager.getInstance().requestPermission(this, new OnPermissionCallback() {
                    @Override
                    public void onSuccess(String... permissions) {
